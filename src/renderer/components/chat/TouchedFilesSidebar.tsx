...
> = {
  created: {
    label: "A",
    nameClass: "text-accent-green",
    badgeClass: "text-accent-green",
  },
  modified: {
    label: "M",
    nameClass: "text-accent-amber",
    badgeClass: "text-accent-amber",
  },
  deleted: {
    label: "D",
    nameClass: "text-accent-red line-through opacity-60",
    badgeClass: "text-accent-red",
  },
};
    ...
    <div>
      ...
      >
        ...
        {open ? (
          ...
          <Folder className="h-3.5 w-3.5 shrink-0 text-accent-blue" />
        )}
